...
/*   Updated: 2023/12/04 18:28:46 by tben-dal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	get_h_d_ray(t_cub3d *game)
{
	...
	offset = 0;
	game->rays.hyinter = floor(game->player.y / game->map_info.tile_size) * game->map_info.tile_size;
	if (sin(game->rays.ray_angle) > 0)
		game->rays.hyinter += game->map_info.tile_size;
	...
	while((game->rays.hxinter / game->map_info.tile_size) >= 0 && (game->rays.hxinter / game->map_info.tile_size) < game->map_info.len_x && (game->rays.hyinter / game->map_info.tile_size) >= 0 && (game->rays.hyinter / game->map_info.tile_size) < game->map_info.len_y)
	{
		if (game->pars.map[(int)((game->rays.hyinter - offset) / game->map_info.tile_size)][(int)((game->rays.hxinter) / game->map_info.tile_size)] == '1')
			break;
...
void	get_v_d_ray(t_cub3d *game)
{
	...
	offset = 0;
	game->rays.vxinter = (floor(game->player.x / game->map_info.tile_size)) * game->map_info.tile_size;
	if (cos(game->rays.ray_angle) > 0)
		game->rays.vxinter += game->map_info.tile_size;
	...
	while((game->rays.vxinter / game->map_info.tile_size) >= 0 && (game->rays.vxinter / game->map_info.tile_size) < game->map_info.len_x && (game->rays.vyinter / game->map_info.tile_size) >= 0 && (game->rays.vyinter / game->map_info.tile_size) < game->map_info.len_y)
	{
		if (game->pars.map[(int)((game->rays.vyinter) / game->map_info.tile_size)][(int)((game->rays.vxinter - offset) / game->map_info.tile_size)] == '1')
			break;
